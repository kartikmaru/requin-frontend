    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="bg-white rounded-2xl shadow-sm p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-slate-50 rounded-xl flex items-center justify-center" style={{ minHeight: 280 }}>
            {product.image ? (
              <img
                src={product.image}
                alt={product.name}
          ...
          <div className="flex flex-col">
            ...
            <p className="text-3xl font-extrabold text-indigo-600 mb-2">${product.price.toFixed(2)}</p>
            ...
            {inStock && (
              <div className="space-y-3">
                ...
                <p className="font-semibold text-slate-700 text-sm">
                  Total: <span className="text-indigo-600 font-extrabold">${(product.price * quantity).toFixed(2)}</span>
                </p>
